    ...
    <div class="section2">
        <div class="table_pc">
            <table>
                ...
                ?>
                <tr>
                    <td><a href="./incruit_view.php?num=<?=$num[$i]?>&category=<?=$param_category?>&page=<?=$page?>"><?=$num[$i]?></a></td>
                    <td><a href="./incruit_view.php?num=<?=$num[$i]?>&category=<?=$param_category?>&page=<?=$page?>"><?=$category[$i]?></a></td>
                    <td><a href="./incruit_view.php?num=<?=$num[$i]?>&category=<?=$param_category?>&page=<?=$page?>"><?=$title[$i]?></a></td>
                    <td><?=$name[$i]?></td>
                    <td><?=$date_val[$i]?></td>
                    <td><?=$click[$i]?></td>
                </tr>
...
<!-- 모바일 버전을 위하여 -->
        <div class="table_mb">
            <ul>
                ...
                ?>
                <li>
                    <a href="./incruit_view.php?num=<?=$num[$i]?>&category=<?=$param_category?>&page=<?=$page?>">
                        <p><?=$title[$i]?></p>
                        <div class="sub_text">
