...
include "./inc/left.php";
    ...
    //댓글 데이터
    $query_comment  = "select content, id, date from comment where page = 'employment' AND  postnum = '$param_num'";
        ...
        <div class="content">
            <div class="section1">
                <ul>
                    ...
                    <li>
                        <textarea class='cotent_text' readonly style="width:100%; height:35%; border: none; margin-top: 5%; padding: 0% 2%; font-weight: 600;"><?=$content?></textarea>
                    </li>
                </ul>
                <div class="active">
                    <button type="button" class=""><a href="./employment.php?category=<?=$param_category?>&page=<?=$page?>&mode=search&type=<?=$search_type?>&search=<?=$search_text?>">목록</a></button>
        ...
        <div class="content">
            <div class="section1">
                ...
                <div class="active">    
                            ...
                            <button type="button" class=""><a href="./employment.php?page=<?=$page?>&category=<?=$param_category?>&mode=search&type=<?=$search_type?>&search=<?=$search_text?>">목록</a></button>
                </div>
            </div>
        </div> <!-- content -->
</form>
